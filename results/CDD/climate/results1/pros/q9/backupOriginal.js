export default [
  ...
  },
  {
    transcription: {
      ...
      response: {
        ...
        completion:
          "\n1. The speaker supports introducing methane standards to large facilities and corporations.\n2. The speaker does not want to harm with these with a regulation.\n3. The speaker agrees what he said about taxing people, introducing to the market higher cost to discourage me consumed.",
      },
    },
    response: {
      config:
        '{"model":"text-davinci-002","prompt":"Given the following proposal: \\"In order to reduce methane emissions produced by livestock, the US should launch an educational campaign to encourage people to reduce their meat and dairy consumption.\\"\\n###\\nQuestion 2. List if each argument is a A) pro B) con C) not applicable to the given proposal.\\n\\n1.\\n1. The speaker supports introducing methane standards to large facilities and corporations.\\n2. The speaker does not want to harm with these with a regulation.\\n3. The speaker agrees what he said about taxing people, introducing to the market higher cost to discourage me consumed.","temperature":0.08,"max_tokens":256,"top_p":0.06,"frequency_penalty":0,"presence_penalty":0}',
      completion:
        "\n4. The speaker thinks that the government should not get involved with what people are eating.\n\nA) Pro\nB) Con\nC) Not applicable",
    },
    proposalText:
      ' "In order to reduce methane emissions produced by livestock, the US should launch an educational campaign to encourage people to reduce their meat and dairy consumption."',
    proposalNumber: "q9",
  ...
  },
  {
    ...
    response: {
      ...
      completion:
        "\n3. The proposal will not work because people will not change their diets.\n\n1. C\n2. C\n3. B",
    },
    proposalText:
      ' "In order to reduce methane emissions produced by livestock, the US should launch an educational campaign to encourage people to reduce their meat and dairy consumption."',
    proposalNumber: "q9",
  ...
  },
  {
    ...
    response: {
      ...
      completion:
        "\n\nA) Pro\n\n2.\nThe speaker argues that the government should not be in the business of telling people what to eat.\n\nB) Con",
    },
    proposalText:
      ' "In order to reduce methane emissions produced by livestock, the US should launch an educational campaign to encourage people to reduce their meat and dairy consumption."',
    proposalNumber: "q9",
