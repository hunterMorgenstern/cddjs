const res = [
  ...
  },
  {
    proposal:
      "The US should launch an educational campaign to encourage people to reduce their meat and dairy consumption.",
    "pro/con/undecided":
      " The argument implies that the speaker is con-proposal.",
    reason:
      "2. The argument states that the American public will interpret the educational campaign as a call to stop eating meat entirely, which the speaker believes is not realistic. The argument also mentions that farmers are already regulated when it comes to methane emissions, so the speaker believes that the government does not need to get involved.",
    order: "2",
    author: "Laura",
  ...
  },
  {
    ...
    reason:
      "2. The argument does not provide enough information to determine the speaker's position on the proposal.",
    order: "3",
    author: "Wendi",
  ...
  },
  {
    ...
    "pro/con/undecided":
      " The argument does not imply the speaker's position on the proposal. ",
    reason:
      "2. The speaker argues that there is not enough data to convince them that cows are the problem with global warming. They state that the sun is likely doing more to control global warming than cows are.",
    order: "4",
    author: "Charles",
  ...
  },
  {
    ...
    "pro/con/undecided":
      " The argument does not imply the speaker's position on the proposal. ",
    reason:
      "2. The speaker argues that the cost of methane should be paid by those who produce it, which would make beef more expensive. The speaker does not say whether or not this is a good or bad thing.",
    order: "6",
    author: "Adam M",
  ...
  },
  {
    ...
    "pro/con/undecided":
      " The argument does not imply the speaker's position on the proposal.",
    reason:
      "2. The argument is that the US should launch an educational campaign to encourage people to reduce their meat and dairy consumption because it would shift the market towards more chicken and less beef.",
    order: "7",
    author: "Laura",
  ...
  },
  {
    ...
    "pro/con/undecided":
      " The argument does not imply the speaker's position on the proposal. ",
    reason:
      "2. The argument is about how methane gas produced by the sewage plant could be used to heat homes, which is not related to the proposal.",
    order: "12",
    author: "Jim",
  ...
  },
  {
    ...
    reason:
      "2. The argument implies that the speaker is in favor of an educational campaign to encourage people to reduce their meat and dairy consumption. The argument is based on the idea that such a campaign would have positive health benefits and would improve the treatment of animals.",
    order: "13",
    author: "Caitlin",
