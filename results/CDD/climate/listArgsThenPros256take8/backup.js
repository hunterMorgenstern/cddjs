export default [
  ...
  },
  {
    transcription: {
      ...
      response: {
        ...
        completion:
          "\n1. The speaker does not believe that there is enough data to support the idea that cows are the problem with global warming.\n2. The speaker believes that it is better to manage farms at the local level.\n3. The speaker believes that the sun is more responsible for global warming than cows are.",
      },
    },
    response: {
      config:
        '{"model":"text-davinci-002","prompt":"Given the following proposal: \\"In order to reduce methane emissions produced by livestock, the US should launch an educational campaign to encourage people to reduce their meat and dairy consumption.\\"\\n###\\nQuestion 2. List if each argument is a A) pro B) con C) neutral D) not applicable\\n\\n1. The speaker does not believe that there is enough data to support the idea that cows are the problem with global warming.\\n2. The speaker believes that it is better to manage farms at the local level.\\n3. The speaker believes that the sun is more responsible for global warming than cows are.","temperature":0.08,"max_tokens":256,"top_p":0.06,"frequency_penalty":0,"presence_penalty":0}',
      completion: "\n\nA) pro\nB) con\nC) neutral\nD) not applicable",
    },
  },
  {
  ...
  },
  {
    ...
    response: {
      config:
        '{"model":"text-davinci-002","prompt":"Given the following proposal: \\"In order to reduce methane emissions produced by livestock, the US should launch an educational campaign to encourage people to reduce their meat and dairy consumption.\\"\\n###\\nQuestion 2. List if each argument is a A) pro B) con C) neutral D) not applicable\\n\\n1. The speaker argues that we should let the market shift towards more chicken less beef.\\n2. The speaker argues that this would be good for the environment.","temperature":0.08,"max_tokens":256,"top_p":0.06,"frequency_penalty":0,"presence_penalty":0}',
      completion:
  ...
  },
  {
    ...
    response: {
      ...
      completion:
        "\n3. The government should incentivize companies to reduce methane emissions.\n4. The government should provide more information to the public about the benefits of reducing methane emissions.\n\n1. C\n2. B\n3. A\n4. A",
    },
  },
  {
    transcription: {
