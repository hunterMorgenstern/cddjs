const r = [
  ...
  },
  {
    ...
    rawPrompt:
      '\n###\nGiven the following proposal:  "In order to reduce methane emissions produced by livestock, the US should launch an educational campaign to encourage people to reduce their meat and dairy consumption."\n###\nQuestion 2. List if each argument is a A) pro B) con C) not applicable to the given proposal.\n\n1. The speaker believes that regulating large farms would be beneficial because they produce a lot of methane gas.\n2. The speaker argues that food waste from large farms is a problem because it contributes to pollution.',
    settings: { temperature: 0.08, max_tokens: 256, top_p: 0.06 },
    pros: "\n\n1. The speaker believes that reducing meat and dairy consumption would be beneficial because it would reduce methane emissions.\n2. The speaker argues that food waste from large farms is a problem because it contributes to pollution.\n\n1. A\n2. Not applicable",
  },
  {
    proposal:
      "In order to reduce methane emissions produced by livestock, the US should launch an educational campaign to encourage people to reduce their meat and dairy consumption.",
  ...
  },
  {
    ...
    rawPrompt:
      '\n###\nGiven the following proposal:  "In order to reduce methane emissions produced by livestock, the US should launch an educational campaign to encourage people to reduce their meat and dairy consumption."\n###\nQuestion 2. List if each argument is a A) pro B) con C) not applicable to the given proposal.\n\n1. The speaker believes that the market should shift towards more chicken and less beef.\n2. The speaker believes that this shift will happen naturally, without intervention.',
    settings: { temperature: 0.08, max_tokens: 256, top_p: 0.06 },
    pros: "\n\n1. The US should launch an educational campaign to encourage people to reduce their meat and dairy consumption.\n2. In order to reduce methane emissions produced by livestock, the US should launch an educational campaign to encourage people to reduce their meat and dairy consumption.\n3. The US should not launch an educational campaign to encourage people to reduce their meat and dairy consumption.\n\n1. A\n2. A\n3. B",
  },
  {
    proposal:
      "In order to reduce methane emissions produced by livestock, the US should launch an educational campaign to encourage people to reduce their meat and dairy consumption.",
  ...
  },
  {
    ...
    rawPrompt:
      '\n###\nGiven the following proposal:  "In order to reduce methane emissions produced by livestock, the US should launch an educational campaign to encourage people to reduce their meat and dairy consumption."\n###\nQuestion 2. List if each argument is a A) pro B) con C) not applicable to the given proposal.\n\n1. We need to be careful with placing regulations on things like that.\n2. It can be a slippery slope.\n3. Weighing the pros and cons of regulations against people\'s choices in the economy.',
    settings: { temperature: 0.08, max_tokens: 256, top_p: 0.06 },
    pros: "\n\n1. It can be a slippery slope.\n2. Weighing the pros and cons of regulations against people's choices in the economy.\n3. We need to be careful with placing regulations on things like that.\n\nA) for\nB) against\nC) not applicable",
  },
  {
    proposal:
      "In order to reduce methane emissions produced by livestock, the US should launch an educational campaign to encourage people to reduce their meat and dairy consumption.",
  ...
  },
  {
    ...
    rawPrompt:
      '\n###\nGiven the following proposal:  "In order to reduce methane emissions produced by livestock, the US should launch an educational campaign to encourage people to reduce their meat and dairy consumption."\n###\nQuestion 2. List if each argument is a A) pro B) con C) not applicable to the given proposal.\n\n1. Education campaigns to promote a more vegetarian lifestyle are necessary.\n2. People don\'t need to give up meat completely, but should eat less of it.\n3. The health benefits of eating vegetables are well-known.\n4. The treatment of animals is another reason to eat less meat.',
    settings: { temperature: 0.08, max_tokens: 256, top_p: 0.06 },
    pros: "\n\n1. Education campaigns to promote a more vegetarian lifestyle are necessary. A\n2. People don't need to give up meat completely, but should eat less of it. A\n3. The health benefits of eating vegetables are well-known. C\n4. The treatment of animals is another reason to eat less meat. A",
  },
  {
    proposal:
      "In order to reduce methane emissions produced by livestock, the US should launch an educational campaign to encourage people to reduce their meat and dairy consumption.",
