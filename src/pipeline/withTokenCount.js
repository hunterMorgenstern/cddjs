...
const withTokenCount = [
  ...
  { order: 17, author: "Erick", text: " which long beach?", tokenCount: 4 },
  {
    order: 18,
    author: "Chanel",
  ...
  { order: 19, author: "Erick", text: " it doesn't count.", tokenCount: 5 },
  {
    order: 20,
    author: "Chanel",
    text: " i,aom very glad you're here today!",
    tokenCount: 11,
  },
  {
    order: 21,
  ...
  { order: 30, author: "Gary", text: " if you got wages,ap", tokenCount: 6 },
  {
    order: 31,
    author: "Will",
  ...
  { order: 52, author: "Someone", text: " correct", tokenCount: 1 },
  {
    order: 53,
    author: "Will",
  ...
  { order: 92, author: "Jackie", text: " yeah. yes, it is.", tokenCount: 7 },
  {
    order: 93,
    author: "Angela",
  ...
  { order: 133, author: "Gary", text: " and job distribution.", tokenCount: 4 },
  {
    order: 134,
    author: "Angela",
  ...
  { order: 145, author: "Gary", text: " no. cannot afford it.", tokenCount: 6 },
  {
    order: 146,
    author: "Erick",
  ...
  { order: 150, author: "Ken", text: " well that's true that", tokenCount: 5 },
  {
    order: 151,
    author: "Nancy",
  ...
  },
  {
    order: 155,
    author: "Mike",
    text: " where'd that figure come from?",
    tokenCount: 7,
  },
  {
    order: 156,
  ...
  { order: 159, author: "Jackie", text: " make them here.", tokenCount: 4 },
  {
    order: 160,
    author: "Erick",
  ...
  },
  {
    order: 178,
    author: "Nancy",
    text: " it's a 27 like a 20 million people.",
    tokenCount: 10,
  },
  {
    order: 179,
  ...
  },
  {
    order: 187,
    author: "Nancy",
    text: " yeah, no but not once you retire.",
    tokenCount: 9,
  },
  {
    order: 188,
